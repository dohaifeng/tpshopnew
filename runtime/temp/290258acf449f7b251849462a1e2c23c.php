<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index\welcome.html";i:1512439387;}*/ ?>
<html>
<head>
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
                                ...
                                <td>Hardrock shop <?php echo $sys_info['version']; ?></td>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b>版权所有 © 2012-2017 杭州启焕网络科技有限公司，并保留所有权利。</b></p>
</div>
